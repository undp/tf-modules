...
variable "conf_map" {
  description = "Map of locations to region-specific configuration parameters applied to each individual region."
  type        = any
  default     = {}
}

variable "namespace" {
  description = "Namespace to use as a prefix in resource names and in tags."
  type        = string
  default     = ""
}
